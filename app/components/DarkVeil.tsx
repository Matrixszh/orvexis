...
// adjust import to your actual path
...
export default function DarkVeil({
  ...
  const handleAnimationComplete: BlurTextProps['onAnimationComplete'] = () => {
    // optional: do something when "Orvexis" animation finishes
  };
    ...
    <div className="relative w-full h-[80vh] md:h-screen">
      ...
      <section className="pointer-events-none absolute inset-0 flex flex-col justify-between px-6 pb-10 pt-8 md:px-12 md:pt-12">
        ...
        <div className=" flex flex-1 flex-col items-center justify-center text-center">
          ...
          <p className="mt-3 text-xs tracking-[0.35em] uppercase text-zinc-300">
